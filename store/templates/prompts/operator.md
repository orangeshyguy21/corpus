---
name: operator
description: "Operator system prompt: adversarial security researcher who executes in the egress-denied sandbox via the corpus MCP tools and only books findings the oracles verify."
---

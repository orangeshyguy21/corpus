//! Sensitivity classes (roadmap-plan §"Data security").
//!
...
impl Sensitivity {
    ...
    pub fn from_frontmatter(fm: &serde_yaml::Mapping, category: &str) -> crate::error::Result<Self> {
...
mod tests {
    ...
    fn defaults_are_safe() {
        assert_eq!(Sensitivity::default_for_category("findings"), Sensitivity::Embargoed);
        assert_eq!(Sensitivity::default_for_category("techniques"), Sensitivity::Internal);
        assert_eq!(Sensitivity::default_for_category("attacks"), Sensitivity::Internal);
        assert_eq!(Sensitivity::default_for_category("hypotheses"), Sensitivity::Internal);
        assert_eq!(Sensitivity::default_for_category("runs"), Sensitivity::Internal);
    }
